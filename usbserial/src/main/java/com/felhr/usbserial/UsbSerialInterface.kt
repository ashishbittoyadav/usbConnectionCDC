...
interface UsbSerialInterface {
    ...
    fun syncWrite(buffer: ByteArray?, offset: Int, length: Int, timeout: Int): Int
    fun syncRead(buffer: ByteArray?, offset: Int, length: Int, timeout: Int): Int
    fun syncClose()
